...
const FName ARacerPawn::LookUpBinding("LookUp");
const FName ARacerPawn::LookRightBinding("LookRight");
const FName ARacerPawn::EngineAudioRPM("RPM");
...
void ARacerPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ARacerPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ARacerPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &ARacerPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &ARacerPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ARacerPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ARacerPawn::OnResetVR); 
}
...
void ARacerPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ARacerPawn::EnableIncarView(const bool bState)
{
...
void ARacerPawn::UpdateHUDStrings()
{
...
void ARacerPawn::UpdatePhysicsMaterial()
{
